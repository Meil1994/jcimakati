...
<footer>
    <div class="container footer-content">
      <div class="footer-top">
        <div class="logo-details">
          <span class="logo_name"><a href = "index.php"><img src="images/jcilogo.png" style="height: 100px; width: 200px"></a></span>
        </div>
        
        <div class="media-icons">
          <a href="https://www.facebook.com/jcimakatiofficial" target="_blank"><i class="fa fa-facebook"></i></a>
          <a href= "https://www.instagram.com/jcimakatiofficial/?hl=en" target="_blank"><i class="fa fa-instagram"></i></a>
          <a href= "https://twitter.com/jcimakati?lang=en" target="_blank"><i class="fa fa-twitter"></i></a>
          <a href= "https://www.youtube.com/channel/UCyDXXq4xh50GLXsQ6_d5h-Q" target="_blank"><i class="fa fa-youtube"></i></a>
      ...
      <div class="row footer-link-boxes">
        ...
        <ul class="col-sm-4 col-md-3 footer-box w-100">
          ...
          <li><a href="https://www.facebook.com/beautyvaultphmain/" target="_blank" alt = "Beauty Vault FB Link">Beauty Vault</a></li>
          <li><a href="https://www.facebook.com/takarahotel/" target= "_blank" alt = "Takara Hotel FB">Takara Hotel</a></li>
        </ul>
        <ul class="col-sm-4 col-md-3 footer-box w-100">
          <li><a href="#">Titans Inc.</a></li>
          <li><a href="#">The Hungry Minds Inc.</a></li>
          <li><a href="#">First Paragon Logistics International Inc.</a></li>
          <li><a href="https://www.topyugo.com/" target= "_blank" alt = "Topyugo Website Link">Topyugo Digital Inc.</a></li>
          <li><a href="#">ICON</a></li>
          <li><a href="https://www.facebook.com/TeamAdvocateChangeClub/" target="_blank" alt = "Advocate Change Club FB Link">Advocate Change Club</a></li>
        </ul>
    ...
    <div class="footer-bottom-details">
      <div class="footer-bottom_text">
        ...
        <span class="copyright_text text-secondary"> Copyright © 2023 <a href="https://jcimakati.org/" target="_blank" alt = "JCI Makati Website" style = "color: #0A0F29; font-weight: bold">JCI Makati.</a>All rights reserved.</span>
